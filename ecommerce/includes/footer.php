<footer class="footer layout_padding darkback">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-12">
                <a href="index.html"><img class="logofoot" src="images/logo_footer.png" alt="#" /></a>
            </div>
...
<div class="cpy darkback">
    <div class="container">
        <div class="row " id="aligncent">
            <div class="col-md-12 ">
                <p>© 2020 All Rights Reserved. <a href="">Chris Grundling</a></p>
            </div>
        </div>
    </div>
</div>